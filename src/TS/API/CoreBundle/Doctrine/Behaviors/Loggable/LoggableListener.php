...
namespace TS\API\CoreBundle\Doctrine\Behaviors\Loggable;
...
use TS\API\CoreBundle\Doctrine\Behaviors\Loggable\Entity\EntityLogEntry;
...
class LoggableListener extends BaseLoggableListener
{
    ...
    {
        return $this->getClassAnalyzer()->hasTrait($reflClass, 'TS\API\CoreBundle\Doctrine\Behaviors\Loggable\Loggable', $this->isRecursive);
    }
